 ...
 */
export const getList = <T = any, K = FrappeDoc<T>>(
  doctype: string,
 ...
 */
export const callPost = <T = any>(method: string) => {
 ...
 */
export const callPut = <T = any>(method: string) => {
  const { call, result, loading, error, isCompleted, reset } =
 ...
 */
export const callDelete = <T = any>(method: string) => {
  const { call, result, loading, error, isCompleted, reset } =
