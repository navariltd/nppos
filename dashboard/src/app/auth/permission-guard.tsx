 ...
 *   - localStorage ("nppos_session" key) for auth state detection
 */
...
/**
 * Check if user has a stored session by reading localStorage directly.
 * Mirrors the logic in user-context.tsx for auth state detection.
 */
function isUserLoggedIn(): boolean {
  try {
    const raw = localStorage.getItem("nppos_session");
